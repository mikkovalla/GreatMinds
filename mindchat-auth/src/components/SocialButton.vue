<template>
  <a
    ...
    @click="$emit('click')"
  >
    <svg v-if="provider === 'facebook'" width="10" height="20" viewBox="0 0 10 20" fill="none">
    ...
    <svg v-else-if="provider === 'twitter'" width="22" height="16" viewBox="0 0 22 16" fill="none">
    ...
    <svg v-else-if="provider === 'google'" width="18" height="18" viewBox="0 0 18 18" fill="none">
