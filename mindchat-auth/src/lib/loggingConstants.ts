...
export enum StripeEvent {
  ...
  CHECKOUT_SESSION_CREATED = 7010,
  PORTAL_SESSION_CREATED = 7020,
  SUBSCRIPTION_SYNCED = 7030,
  WEBHOOK_VALIDATED = 7040,
  ...
  USER_PROFILE_RETRIEVAL_FAILED = 7110,
  CHECKOUT_SESSION_FAILED = 7111,
  CUSTOMER_CREATION_ERROR = 7112,
  DATABASE_UPDATE_FAILED = 7113,
  PORTAL_SESSION_FAILED = 7120,
  SUBSCRIPTION_RETRIEVAL_FAILED = 7130,
  SUBSCRIPTION_UPDATE_FAILED = 7131,
  WEBHOOK_VERIFICATION_FAILED = 7140,
  WEBHOOK_PROCESSING_FAILED = 7107,
  INVALID_WEBHOOK_SIGNATURE = 7109,
  STRIPE_API_ERROR = 7150,
}
